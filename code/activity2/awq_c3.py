...
def main():
    ...
    # Primary:  ./outputs/dacs_calib_512.jsonl  — generated by prepare_dacs_calib.py
    # Fallback: ./data/dacs_calib_512.jsonl     — committed copy (convenience backup)
    # Anyone cloning this repo fresh should run prepare_dacs_calib.py to regenerate
    # from source (downloads Trendyol corpus, extracts assistant-turn texts).
    ...
    print(f"[1/3] Loading DACS calibration data from {calib_path}...")
