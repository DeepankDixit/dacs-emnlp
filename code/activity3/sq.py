"""
DACS Activity 3 — INT8 SmoothQuant (parameterized by domain + calibration)
===========================================================================
Usage:
    python activity3/sq.py --domain med  --cond c1|c2|c3
    python activity3/sq.py --domain code --cond c1|c2|c3

Input:    ./outputs/{domain}_fp16/ + calibration JSONL
Output:   ./outputs/{domain}_int8_sq_{cond}/  (~8 GB)
...
def main(domain: str, cond: str):
    ...
    out_path   = model_out_path(domain, "int8_sq", cond)
    os.makedirs(out_path, exist_ok=True)

    print("=" * 60)
    print(f" Activity 3 — INT8 SmoothQuant  |  domain={domain}  |  calib={cond}")
    print("=" * 60)
